...
class Board:
    ...
    def make_new_board(self):
        ...
        # but since we have a @d board, list of lists is most natural)
    ...
    def assign_values_to_board(self):
        ...
        # represents how many neighboring bombs there are. we can precompute these and itll save us some
    ...
    def dig(self, row, col):
        ...
        # if our initital dig didnt hit a bomb we *shouldnt* hit a bomb here
        return True

    def __str__(self):
        #this is a magic function where if you call print on this object,
        # itll print out what this function returns!
...
def play(dim_size = 10, num_bombs=10):
    ...
    # step 3a: if location is a bomb, show game oever message
